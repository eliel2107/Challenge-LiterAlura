package br.com.eliel2107.litreralura.principal;

import br.com.eliel2107.litreralura.model.Book;
import br.com.eliel2107.litreralura.model.ListBooks;
...
import br.com.eliel2107.litreralura.service.ConsumoApi;
import br.com.eliel2107.litreralura.service.ConverteDados;
...
public class Principal {
    ...
    private List<Book> buscarTodosOsLivros(int totalPaginas) {
        ...
        for (int i = 1; i <= totalPaginas; i++) {
            ...
            allBooks.addAll((Collection<? extends Book>) listBook.getResults());
        }
